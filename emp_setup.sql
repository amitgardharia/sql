...
union all
select date'2018-02-01', 2, 'b@test.com', 'temp', date'2018-12-31' from dual
union all
select date'2018-03-01', 2, 'b@test.com', 'temp', date'2018-04-30' from dual
union all
select date'2018-04-01', 2, 'b@test.com', 'temp', date'2018-04-30' from dual
union all
select date'2018-07-01', 2, 'b@test.com', 'full', date'2018-07-31' from dual
union all
select date'2018-09-01', 2, 'b@test.com', 'full', date'2018-12-31' from dual
